...
| [vllm_ascend_runtime_graph_and_padding](vllm_ascend_runtime_graph_and_padding.md) | profile_run, dummy_run, ACLGraph, CUDAGraph, ACLGraphWrapper, CUDAGraphWrapper, graph-capture, DP-padding, cudagraph_capture_sizes, FlashComm1, num_tokens_across_dp, GraphParams, AbstractStaticGraphWrapper | profile run / graph capture / DP padding 的关系，ACLGraph 与 CUDAGraph wrapper 级别详细对比，以及 Ascend 侧特化行为（流同步、GraphParams、shape 裁剪） |
